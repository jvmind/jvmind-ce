...
GC_FIXTURES = {
    ...
    "gc-jdk21-generational-zgc.log": {"jdk": "9+", "collector": "Z", "required": {"ZGC", "Concurrent"}, "allowed": {"ZGC", "Concurrent", "Other", "Young", "Full"}},
    ...
    "gc-jdk25-generational-zgc.log": {"jdk": "9+", "collector": "Z", "required": {"ZGC", "Concurrent"}, "allowed": {"ZGC", "Concurrent", "Other", "Young", "Full"}},
    ...
    "gc-jdk25-zgc.log": {"jdk": "9+", "collector": "Z", "required": {"ZGC"}, "allowed": {"ZGC", "Concurrent", "Other", "Young", "Full"}},
}
